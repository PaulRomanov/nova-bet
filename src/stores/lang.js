...
export const translations = {
  ru: {
    ...
    errCasinoNotOwner: 'Ошибка: Вы не являетесь владельцем контракта!',
    errCasinoBetTooSmall: 'Ставка слишком мала!',
    errCasinoBetTooLarge: 'Ставка слишком велика!',
    errCasinoInsufficientBalance: 'Недостаточно средств на депозите казино. Пожалуйста, пополните баланс!',
    errCasinoZeroDeposit: 'Сумма депозита должна быть больше нуля!',
    errCasinoZeroWithdraw: 'Сумма вывода должна быть больше нуля!',
    errCasinoTransferFailed: 'Перевод средств не удался!',
    errCasinoInvalidChoice: 'Неверный выбор стороны!',
    errCasinoInsufficientReserve: 'Недостаточно резервов в банке казино для выплаты выигрыша!',
  },
  en: {
    ...
    errCasinoNotOwner: 'Error: You are not the contract owner!',
    errCasinoBetTooSmall: 'Bet is too small!',
    errCasinoBetTooLarge: 'Bet is too large!',
    errCasinoInsufficientBalance: 'Insufficient funds on casino deposit. Please, top up your balance!',
    errCasinoZeroDeposit: 'Deposit amount must be greater than zero!',
    errCasinoZeroWithdraw: 'Withdrawal amount must be greater than zero!',
    errCasinoTransferFailed: 'Transfer failed!',
    errCasinoInvalidChoice: 'Invalid choice!',
    errCasinoInsufficientReserve: 'Insufficient casino reserve to cover this bet!',
  },
}
