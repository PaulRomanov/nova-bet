...
function formatTs(ts) {
  const locale = lang.currentLang === 'ru' ? 'ru-RU' : 'en-US'
  ...
  <div class="min-h-screen bg-gray-950 text-slate-100 font-sans">
    ...
    >
      ...
      <aside class="flex flex-col gap-5">
        ...
        <!-- History -->
        <div
          class="rounded-2xl bg-white/5 border border-white/10 p-5 backdrop-blur-sm flex-1"
        >
          ...
          <ul v-else class="space-y-2">
            ...
            >
              ...
              <span
                :class="g.won ? 'text-emerald-400' : 'text-red-400'"
                class="font-bold"
              >
    ...
    <Transition name="modal">
      ...
      >
        ...
        >
          ...
          <div
            class="absolute inset-0 -z-10 rounded-3xl opacity-20 blur-2xl transition-all duration-350"
            :class="
              modalData.won
          ...
          <h2
            ...
            "
          >
            {{ modalData.won ? lang.t.winModalTitle : lang.t.loseModalTitle }}
          </h2>
